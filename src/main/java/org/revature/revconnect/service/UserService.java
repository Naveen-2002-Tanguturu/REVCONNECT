...
public class UserService {
    ...
    public PagedResponse<UserResponse> searchUsers(String query, int page, int size) {
        ...
        return PagedResponse.<UserResponse>builder()
                .content(usersPage.getContent().stream()
                        .map(UserResponse::fromEntityPublic)
                        .toList())
    ...
    public void blockUser(Long userId) {
        ...
        if (currentUser.getId().equals(userId)) {
            throw new com.revconnect.exception.BadRequestException("Cannot block yourself");
        }
    ...
    public void reportUser(Long userId, String reason) {
        User currentUser = authService.getCurrentUser();
        if (currentUser.getId().equals(userId)) {
            throw new com.revconnect.exception.BadRequestException("Cannot report yourself");
        }
